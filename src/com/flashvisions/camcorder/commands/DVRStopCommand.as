package com.flashvisions.camcorder.commands
{
	...
	public class DVRStopCommand implements ICommand
	{
		...
		public function execute(event:CairngormEvent):void
		{
			...
			if(connection && connection.connected && stream && modelLocator.isBroadcasting)
			{
				...
				if(modelLocator.dvrInfo != null)
				{
					...
					dvrInfo.startRec = new Date(1970, 0, 1, 0, 0, 0);
					dvrInfo.stopRec = callTime;
				...
				else
				{
					dvrInfo.streamName = modelLocator.publishName;
					dvrInfo.callTime = callTime;
					dvrInfo.startRec = new Date(1970,01, 01);
					dvrInfo.stopRec = callTime;
					dvrInfo.maxLen = 0;
					dvrInfo.begOffset = 0;
					dvrInfo.endOffset = 0;
		...
		public function status(info:Object):void
		{
			...
			trace("Status " + info.toString());
		}
		
		public function result(data:Object):void
		{
			// TODO Auto Generated method stub
			trace("Response " + data.toString());
		}
	}
}